...
В этом пошаговом руководстве описано, как загрузить файл на сервер, запустить gpfdist и создать External table, скопировать данные из внешней таблицы во внутреннюю таблицу GreenPlum.
...
## 5. Запускаем gpfdist
В этом же окне терминала подключаемся к серверу и запускаем в папке, где находится загруженный файл, gpfdist:
...
## 7. Скопируем данные из внешней таблицы во внутреннюю таблицу GreenPlum
