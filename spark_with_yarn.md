...
При необходимости указанные ниже шаги могут быть выполнены запуском скрипта `task4.sh` (установка виртуальной среды и выполнение операций по чтению и трансформации данных)
...
df = df.repartition(num_part, "column")
